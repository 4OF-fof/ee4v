...
namespace _4OF.ee4v.Core.UI.Window {
    public class ComponentInspectorWindow : BaseWindow {
        ...
        public static void Open(UnityEngine.Component component, GameObject obj, Vector2 anchorScreen) {
            var window = OpenSetup<ComponentInspectorWindow>(anchorScreen, component);
        ...
        public static void Open(Material material, GameObject obj, Vector2 anchorScreen) {
            var window = OpenSetup<ComponentInspectorWindow>(anchorScreen, material);
