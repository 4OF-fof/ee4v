...
namespace _4OF.ee4v.Core.Setting {
    public static class EditorPrefsManager {
        ...
        public static string Language {
            get => UnityEditor.EditorPrefs.GetString(LanguageKey, "ja-JP");
            set => UnityEditor.EditorPrefs.SetString(LanguageKey, value ?? "ja-JP");
        }
        ...
        public static string ContentFolderPath {
            get {
                ...
                return UnityEditor.EditorPrefs.GetString(ContentFolderPathKey, defaultPath);
            }
            set => UnityEditor.EditorPrefs.SetString(ContentFolderPathKey, value ?? "");
        }
        ...
        public static string SceneCreateFolderPath {
            get {
                ...
                return UnityEditor.EditorPrefs.GetString(SceneCreateFolderPathKey, defaultPath);
            }
            set => UnityEditor.EditorPrefs.SetString(SceneCreateFolderPathKey, value ?? "Assets/");
        }
