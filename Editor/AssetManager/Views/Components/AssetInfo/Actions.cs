        ...
        public Actions() {
            _downloadButton = new Button(() =>
            {
                ...
                style = {
                    ...
                    backgroundColor = ColorPreset.SPrimary, color = ColorPreset.TextColor,
            ...
            {
                _downloadButton.style.backgroundColor = ColorPreset.SPrimaryHover;
            });
            _downloadButton.RegisterCallback<MouseLeaveEvent>(_ =>
            {
                _downloadButton.style.backgroundColor = ColorPreset.SPrimary;
            });
