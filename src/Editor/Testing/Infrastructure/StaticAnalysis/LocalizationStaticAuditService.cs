...
namespace Ee4v.Testing.Infrastructure.StaticAnalysis
{
    ...
    internal static class LocalizationStaticAuditService
    {
        ...
        private static IReadOnlyList<CodeReference> ScanCodeReferences()
        {
            ...
            foreach (var filePath in scripts)
            {
                ...
                var matches = TranslationCallRegex.Matches(content);
                ...
                var scopedMatches = ScopedTranslationCallRegex.Matches(
                    content);
