...
namespace Ee4v.UI
{
    internal sealed partial class CatalogWindow
    {
        private sealed class SelectableItemGridCatalogRegistrar : ICatalogRegistrar
        {
            ...
            {
                registry.RegisterStyleSheet("Editor/UI/Components/Collections/ItemGrid/item-grid.uss");
                registry.RegisterStyleSheet("Editor/UI/Components/Inputs/Selection/SelectableItemGrid/selectable-item-grid.uss");
