    ...
    internal static class TypographyStyleResolver
    {
        private static readonly Dictionary<string, TypographyStyleDefinition> Styles =
            new Dictionary<string, TypographyStyleDefinition>(StringComparer.Ordinal)
            {
                ...
                { UiClassNames.MetaLabel, Create(true, 11, 220, 220, 220, 235, TextAnchor.UpperLeft, WhiteSpace.NoWrap) },
                { UiClassNames.MetaValue, Create(false, 12, 235, 235, 235, 235, TextAnchor.UpperRight, WhiteSpace.NoWrap) },
                ...
                { UiClassNames.FeatureSuiteCaseTitle, Create(true, 11, 220, 220, 220, 235, TextAnchor.UpperLeft, WhiteSpace.Normal) },
                { UiClassNames.FeatureSuiteCaseDescription, Create(false, 12, 210, 210, 210, 209, TextAnchor.UpperLeft, WhiteSpace.Normal) },
                { UiClassNames.FeatureSuiteResultTitle, Create(true, 11, 220, 220, 220, 235, TextAnchor.UpperLeft, WhiteSpace.NoWrap) },
                { UiClassNames.FeatureSuiteResultCounts, Create(false, 12, 235, 235, 235, 235, TextAnchor.UpperLeft, WhiteSpace.NoWrap) },
