    ...
    internal static class TypographyStyleResolver
    {
        private static readonly Dictionary<string, TypographyStyleDefinition> Styles =
            new Dictionary<string, TypographyStyleDefinition>(StringComparer.Ordinal)
            {
                ...
                { UiClassNames.SearchFieldPlaceholder, Create(false, UiTypographyTokens.BodyFontSize, UiColorTokens.TextMuted, TextAnchor.MiddleLeft, WhiteSpace.NoWrap) },
                ...
                { UiClassNames.SingleSelectButtonGroupMeta, Create(false, UiTypographyTokens.CaptionFontSize, UiColorTokens.TextMuted, TextAnchor.MiddleRight, WhiteSpace.NoWrap, marginLeft: UiSpacingTokens.Medium) },
