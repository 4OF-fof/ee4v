    ...
    internal static class TypographyStyleResolver
    {
        private static readonly Dictionary<string, TypographyStyleDefinition> Styles =
            new Dictionary<string, TypographyStyleDefinition>(StringComparer.Ordinal)
            {
                ...
                { UiClassNames.HistoryNavigationBreadcrumbItemLabel, Create(false, 12, UiColorTokens.TextPrimary, TextAnchor.MiddleLeft, WhiteSpace.NoWrap) },
                { UiClassNames.HistoryNavigationOverlayRow, Create(false, 12, UiColorTokens.TextPrimary, TextAnchor.MiddleLeft, WhiteSpace.NoWrap) },
                { UiClassNames.HistoryNavigationOverlaySeparator, Create(false, 12, UiColorTokens.TextMuted, TextAnchor.MiddleCenter, WhiteSpace.NoWrap) },
