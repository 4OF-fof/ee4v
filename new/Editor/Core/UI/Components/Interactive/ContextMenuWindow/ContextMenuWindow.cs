...
namespace Ee4v.UI
{
    ...
    internal sealed class ContextMenuWindow : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            UiStyleUtility.AddPackageStyleSheet(root, "Editor/Core/UI/Components/Display/Icon/icon.uss");
            UiStyleUtility.AddPackageStyleSheet(root, "Editor/Core/UI/Components/Interactive/ContextMenuWindow/context-menu-window.uss");
