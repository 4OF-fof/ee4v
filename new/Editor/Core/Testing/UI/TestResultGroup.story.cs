...
namespace Ee4v.UI
{
    ...
    {
        private sealed class TestingCatalogRegistrar : ICatalogRegistrar
        {
            public int Order
            {
                get { return 100; }
            ...
            {
                registry.RegisterStyleSheet("Editor/Core/Testing/UI/test-result-group.uss");
                registry.RegisterStory(new StoryRegistration(
                    ...
                    (window, parent) => window.BuildTestResultGroupStory(parent)));
            }
        }
